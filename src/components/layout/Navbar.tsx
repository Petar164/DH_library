  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-3 sm:px-5 h-11 flex items-center justify-between gap-4">
        ...
        {/* Right — profile + signout, or sign in when browsing signed out */}
        <div className="flex items-center gap-1">
          {profile ? (
            ...
            <Link
              href="/login"
              className="px-2 py-1 text-[11px] font-mono text-black hover:bg-black hover:text-white transition-none"
              style={{ WebkitFontSmoothing: 'none' }}
            >
              Sign in
            </Link>
        ...
        >
          ...
          {profile ? (
            ...
            <Link
              href="/login"
              onClick={() => setMenuOpen(false)}
              className="px-4 py-2.5 text-[11px] font-mono text-black hover:bg-black hover:text-white"
              style={{ WebkitFontSmoothing: 'none' }}
            >
              Sign in
            </Link>
